...
<html>
    ...
    <body class="login-page" style="background-image: url('https://wallpaperset.com/w/full/5/1/1/512933.jpg'); background-size:cover; background-repeat:no-repeat">
        <div class="login-box">
            <div class="login-logo">
                <a href="#" ><b><font color="white">Login</font></b> <font color="white">Admin</font></a>
            </div><!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <form action="<?php echo site_url('Auth/login'); ?>" method="post">
                   ...
                   <div><?php 
                    ...
                    <div class="row">
                        <div class="col-xs-offset-20 col-xs-12">
