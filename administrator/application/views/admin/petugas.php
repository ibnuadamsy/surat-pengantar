...
<section class="content-header">
      <h1>
        Daftar
        <small>Data Petugas RT&RW</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">List Data Ketua RT & RW 12 Kelurahan Pejuang</h3>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped" >
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a data-toggle="modal" data-target="#modal-edit<?=$pet->id_petugas;?>" class="btn btn-warning btn-xs" data-popup="tooltip" data-original-title="Edit Data" data-placement="top" ><i class="fa fa-edit"></i></a>
                                ...
                                <i class="fa fa-random"></i>&nbsp; List Data Admin
                                </button>
            </a>
                            </div>
                              </div>
         ...
         <div class="modal fade" id="modal-tambah">
          <div class="modal-dialog">
            ...
            <div class='col-md-9'>
              <input type="text" readonly="" value="<?= $nomer; ?>" name="id_petugas" class="form-control" required="" >
</div>
          </div>
          <br>
          <div class="form-group">
