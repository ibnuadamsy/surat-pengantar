                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">List Data Pengajuan Pengantar Tervalidasi</h3>
                        </div>
                        <div class="box-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="<?php echo site_url('admin/hapus_peng/'.$val->no_pengantar); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini');" class="btn btn-danger btn-xs tooltips" data-tonggle="tooltip" data-placement="bottom"><i class="glyphicon glyphicon-trash" title="Hapus"></i></a>
