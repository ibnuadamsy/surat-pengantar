                                ...
                                <table id="example1" class="table table-bordered table-striped" >
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a data-toggle="modal" data-target="#modal-show<?=$val->NIK;?>" class="btn btn-warning btn-xs" data-popup="tooltip" data-original-title="Edit Data" data-placement="top" ><i class="fa fa-tripadvisor"></i></a>

                                            <a data-toggle="modal" data-target="#modal-validasi<?=$val->no_pengantar;?>" class="btn btn-primary btn-xs" data-popup="tooltip" data-original-title="Edit Data" data-placement="top" ><i class="fa fa-check-square-o"></i></a>
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class='col-md-9'><input type="text" readonly value="<?=$val->nama;?>" name="nama" autocomplete="off" class="form-control"
              ...
              <div class="col-md-9">
              <select name="status_rt" class="form-control" required="">
              <option value="">Lakukan Validasi</option>
              <option value="2">Validasi RT</option>
              </select>
              </div>
              </div>
              <br>
