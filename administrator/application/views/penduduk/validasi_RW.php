                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a data-toggle="modal" data-target="#modal-show<?=$val->NIK;?>" class="btn btn-warning btn-xs" data-popup="tooltip" title="Detail" data-placement="top" ><i class="fa fa-tripadvisor"></i></a>
                                            ...
                                            <a href="<?php echo site_url('admin/hapus_rw/'.$val->no_pengantar); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini');" class="btn btn-danger btn-xs tooltips" data-popup="tooltip" title="Hapus" data-placement="top"><i class="glyphicon glyphicon-trash"></i></a>
                                    </tr>
                                     <?php endforeach;?>
                                </tbody>
                             </table>
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class='col-md-9'><input type="text" readonly value="<?=$val->nama;?>" name="nama" autocomplete="off" class="form-control"
              ...
              <div class="col-md-9">
              <select name="status_rw" class="form-control" required="">
                    <option value="">Lakukan Validasi</option>
                    <option value="2">Validasi RW</option>
              </select>
              </div>
              </div>
              <br>       
