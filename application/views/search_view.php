            ...
            <td><?php echo $val->NIK;?></td>
                  ...
                  $class="default";
                        ...
                        <?php if (isset($val->status_rt) && ($val->status_rw=='2')&& ($val->status_kel=='2')){
                           echo "<a href=\"/surat-pengantar-pejuang.herokuapp.com/administrator/laporan/laprec/$val->no_pengantar\" type='button' class='btn btn-success btn-xs tooltips'> <span class='glyphicon glyphicon-print'></span> <br>";
