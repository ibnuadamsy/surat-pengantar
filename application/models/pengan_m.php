...
if (!defined('BASEPATH'))
    ...
    function simpan($No_pengantar,$Keperluan,$Lain_lain,$NIK,$status_rt,$status_rw,$status_kel){
    	$hasil=$this->db->query("INSERT INTO pengantar(no_pengantar,keperluan,lain_lain,NIK,status_rt,status_rw,status_kel) VALUES ('$No_pengantar','$Keperluan','$Lain_lain','$NIK','1','1','1')");
    	return $hasil;
    }
